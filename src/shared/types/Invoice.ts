...
export interface InvoiceDto {
  ...
  autoGenerated?: boolean;           // Flag for recurring-invoice-generated invoices
...
export interface RecurringInvoiceDto {
  ...
  invoiceTemplateId: number;        // References invoice_templates.id
  invoiceNumberTemplateId?: number; // For auto-number generation

  // Schedule
  frequency: 'weekly' | 'biweekly' | 'monthly' | 'quarterly';
  dayOfWeek?: number;               // 0=Monday..6=Sunday — for weekly/biweekly
  dayOfMonth?: number;              // 1-31 — for monthly/quarterly (clamped to actual month length)
  monthPosition?: 'first' | 'last'; // Alternative: 1st or last day of month

  // Time range
  startDate: string;                // YYYY-MM-DD
  endDate?: string;                 // YYYY-MM-DD (null = indefinite)

  // Date offsets (days relative to generated invoice date)
  dueDateOffsetDays: number;        // default 30
  deliveryDateOffsetDays: number;   // default 0
...
export interface RecurringInvoiceLogDto {
  id?: number;
